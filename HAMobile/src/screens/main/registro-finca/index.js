    ...
    <SafeAreaView style={styles.container}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        ...
        <View style={styles.footer}>
          {state.step > 1 ? (
            <TouchableOpacity style={styles.navButtonSecondary} onPress={() => state.setStep(state.step - 1)}>
          ...
          {state.step < 3 ? (
            <TouchableOpacity style={styles.navButtonPrimary} onPress={() => state.setStep(state.step + 1)}>
