...
async def list_roles(db: Annotated[Prisma, Depends(get_db)]):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error al recuperar los roles") from None
...
async def create_role(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error interno al crear el rol") from None
...
@router.put(
    ...
    responses={404: {"description": "Rol no encontrado"}, 500: {"description": "Error interno"}},
)
async def update_role(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error interno al actualizar el rol") from None
...
async def delete_role(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error interno al eliminar el rol") from None
